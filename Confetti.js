...
function triggerConfetti() {
    ...
    (function frame() {
        ...
        if (Date.now() < end) {
            ...
            // After confetti ends, start heart effect
            mwah();
        }
    }());
}
...
// Function to close the popup when the button is clicked
function closePopup() {
    const popup = document.getElementById("anniversary-popup");
...
window.onload = checkDateForConfetti;


// Heart effect (from original code)
